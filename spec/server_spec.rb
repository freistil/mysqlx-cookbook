...
describe 'mysqlx::server' do
  ...
  it 'includes _server_rhel on centos5' do
    expect(centos5_run).to include_recipe('mysqlx::_server_rhel')
  end

  it 'includes _server_rhel on centos6' do
    expect(centos6_run).to include_recipe('mysqlx::_server_rhel')
  end

  it 'includes _server_debian on ubuntu1004' do
    expect(ubuntu_1004_run).to include_recipe('mysqlx::_server_debian')
  end

  it 'includes _server_debian on ubuntu1204' do
    expect(ubuntu_1204_run).to include_recipe('mysqlx::_server_debian')
  end
end
